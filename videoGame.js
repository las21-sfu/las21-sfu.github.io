...
/**
 * Toggle insight card text visibility.
 ...
 * Supports both horizontal-only and both-axis scrolling.
...
/* ==========================================================================
   ...
   Screen position: 1st visualization
   HTML target: #vis1
   ========================================================================== */
...
const spec1 = {
  ...
  encoding: {
    ...
    tooltip: [
      ...
      { field: "Total_Global_Sales",  type: "quantitative", format: ".2f", title: "Global Sales (Millions)" }
    ]
  },
  config: {
    view:  { stroke: null },
...
vegaEmbed("#vis1", spec1, { actions: false, renderer: "svg" })
  .then(() => {
    attachDragScroll(".vis1-scroll");

    /* Calculate and display total global sales */
    d3.csv("data/videogames_wide.csv").then(data => {
      const totalSales = d3.sum(data, d => +d.Global_Sales);
      document.getElementById("totalSales").innerText = totalSales.toFixed(2) + " M";
    });
  });

/* ==========================================================================
   VISUALIZATION 2: Console "Genre Personalities" (Radial Donuts)
   Screen position: 2nd visualization
   HTML target: #vis2
   ========================================================================== */
  ...
  spec: {
    ...
    encoding: {
      ...
      tooltip: [
        { field: "Platform", type: "nominal" },
        { field: "Genre",    type: "nominal" },
        { field: "Global_Sales", aggregate: "sum", type: "quantitative", format: ".2f", title: "Total Genre Sales (M)" }
      ]
    }
  },
  config: {
...
/* ==========================================================================
   VISUALIZATION 3: Regional Sales by Genre & Year — Area Chart (multi-row)
   Screen position: 3rd visualization
   HTML target: #vis3
   ========================================================================== */
...
/* ==========================================================================
   ...
   Screen position: 5th visualization
   HTML target: #vis5
   ========================================================================== */
...
const spec5 = {
  ...
  transform: [
    ...
    {
      fold: ["Global_Sales_Sum", "JP_Sales_Sum", "NA_Sales_Sum", "EU_Sales_Sum", "Other_Sales_Sum"],
  ...
  encoding: {
    ...
    tooltip: [
      ...
      { field: "Sales_Value",      type: "quantitative",  format: ".2f", title: "Sales (Millions)" }
    ]
  },
  config: {
...
/* ==========================================================================
   ...
   Screen position: 6th visualization
   HTML target: #vis6
   ========================================================================== */
...
const spec6 = {
  ...
  data: { url: "data/videogames_wide.csv" },
  transform: [
    { filter: { field: "Platform", oneOf: ["X360", "PS3", "Wii", "DS", "PC", "XOne", "PS4", "3DS"] } },
  ...
  encoding: {
    ...
    tooltip: [
      { field: "Platform",         type: "nominal"                                                       },
      { field: "Region",           type: "nominal"                                                       },
      { field: "PercentOfGlobal",  aggregate: "sum", type: "quantitative", format: ".1%", title: "Market Dependency" }
    ]
  },
  config: {
...
/* ==========================================================================
   VISUALIZATION 7: East-West "Symmetry" Plot (NA vs JP)
   Screen position: 7th visualization
   HTML target: #vis7
   ========================================================================== */
...
const spec7 = {
  ...
  encoding: {
    ...
    tooltip: [
      { field: "Platform", type: "nominal"                                                        },
      { field: "NA_Sales", aggregate: "sum", type: "quantitative", title: "Total NA Sales (M)"   },
      { field: "JP_Sales", aggregate: "sum", type: "quantitative", title: "Total JP Sales (M)"   }
    ]
  }
};
...
/* ==========================================================================
   VISUALIZATION 8: Geographic Appeal — NA Sales vs. JP Sales Scatterplot
   Screen position: 8th visualization
   HTML target: #vis8
   ========================================================================== */
...
vegaEmbed("#vis8", spec8, { actions: false, renderer: "svg" })
  .then(() => {
    attachDragScroll(".vis8-scroll", { vertical: true });
  });

/* ==========================================================================
   VISUALIZATION 9: Regional Divergence Heatmap (Top Titles)
   Screen position: 9th visualization
   HTML target: #vis9
   ========================================================================== */
...
vegaEmbed("#vis9", spec9, { actions: false });
